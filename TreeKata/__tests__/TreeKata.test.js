...
describe("TreeKata", () => {
  test.each`
    ...
    ${"(NOT FALSE) AND TRUE AND FALSE OR (TRUE OR FALSE)"}                                                                 | ${true}
    ${"(NOT FALSE) AND TRUE AND (NOT TRUE) OR (TRUE OR FALSE)"}                                                            | ${true}
    ${"(NOT FALSE) AND TRUE AND (NOT TRUE) OR (TRUE OR FALSE) AND (NOT FALSE) AND TRUE AND (NOT TRUE) OR (TRUE OR FALSE)"} | ${true}
  `(
